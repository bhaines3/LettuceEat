          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="form-group">
                    ...
                    <input className="form-control col-sm-12 mb-2" type="password" id="password-login" name="passwordLogin" value={this.state.password} onChange={this.updateUserlogin} maxLength={10} />
                    <br />
